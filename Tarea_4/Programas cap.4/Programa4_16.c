...
inicializa con un valor muy alto para que el primer valor ingresado modifique su contenido.
 HMAX y HMIN se utilizan para almacenar el horario en que se produjeron las temperaturas máxima 
...
/* Esta función almacena la temperatura máxima y la hora en que se produjo en las variables globales 
MAX y HMAX, respectivamente. */
{
if (MAX < T)
{
  MAX = T;
