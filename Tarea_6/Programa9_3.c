#include <stdio.h>
/*Archivos y cadeenas de caracteres.
El programa escribe cadenaas de caracteres en uun archivo. */
...
void main(void)
{
    ...
    /* se abre el archivo para escritura. En el mismo instruccion se verifica si se pudo abrir*/
{
...
while (res)
{
    ...
    gets(cad);
    fputs(cad, ar); //obrserve la forma como se escribe la cadena en el archivo
