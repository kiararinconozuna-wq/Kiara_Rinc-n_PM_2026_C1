...
forma en que se tiene acceso a los campos de las variables de tipo estructura tanto para asignación de valores como para lectura y escritura. */
...
/* Observa que las variables de tipo estructurase declaran como cualquier otra variable. a1, a2y a3 son variables de tipo estructura alumno. */
