...
matpro cal[5];  /* Observa que cales un arreglo unidimensional de tipomestructura matpro—la estructura definida en primer término. */
} alumno;
...
/* Esta función se utiliza para leer la información de un arreglo unidimensional de tipo estructura alumnode Telementos. */
{
int I, J;
for(I=0; I<T; I++)
{
