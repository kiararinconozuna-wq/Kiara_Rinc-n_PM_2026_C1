...
void Lectura(structalumno *);           /* Prototipo de función. */
voidmain(void)
{
structalumno a0 = {120, "María", "Contabilidad", 8.9, "Querétar"};
structalumno *a3, *a4, *a5, a6;
/* Observa que las variables *a3, *a4y *a5 se declaran como apuntadores dentipo estructura alumno. a6 es una variable de tipo estructura alumno. */
...
o bien
(*apuntador).campo
En la lectura de los campos de la variable a4se utilizan como ejemplo ambosformatos. */
...
Lectura(a5);     /* Eneste caso se pasa el apuntador de tipo estructura alumno a5a la función Lectura. */
